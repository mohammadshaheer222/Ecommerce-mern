const NewsLetter = () => {
    return(
        <section className="bg-white md:px-8 py-16">
            <div className="w-full mx-auto flex flex-col justify-center items-center gap-y-4 max-w-[250px] sm:max-w-[360px] md:max-w-[666px]">
                ...
                <div className="flex flex-col justify-between items-center gap-2 sm:flex-row">
                    <input type="email" placeholder="Your Email Address" className="bg-slate-900/5 px-8 py-2 md:px-16 rounded-md ring-1 ring-gray-100 hover:ring-gray-400 outline-none" />
